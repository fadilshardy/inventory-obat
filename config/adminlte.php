...
return [
    ...
    */
    ...
    'title' => 'Inventory Management puskesmas',

    'title_prefix' => 'IM Puskesmas | ',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Tambah obat',
                    'icon' => 'plus',
                    'url' => '/gudangobat/create',
                    'active' => ['/gudangobat/create']
                ],
                [
        ...
        [
            'text' => 'Pelayanan pasien',
            'icon' => 'shopping-cart',
            'submenu' => [
                [
                    'text' => 'Tambah transaksi',
                    'icon' => 'plus',
                    'url' => '/pelayanan/create',
                    'active' => ['/pelayanan/create']
                ],
                [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Laporan stok',
                    'url' => '/laporan/stokobat',
                    'active' => ['/laporan/stokobat']
                ],
                [
                    'text' => 'Laporan gudang',
                    'url' => '/laporan/gudang',
                    'active' => ['/laporan/gudang']
                ],
                [
                    'text' => 'Laporan apotek',
                    'url' => '/laporan/apotek',
